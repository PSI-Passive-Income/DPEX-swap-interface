...
import { Card, CardBody, Text } from '@passive-income/dpex-uikit'
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={TranslateString(
                230,
                'For each trade a 0.3% fee is paid. 0.2% goes to liquidity providers and 0.1% is divided between PSI holders.'
              )}
            />
          </RowFixed>
          <Text fontSize="14px">
